                ...
                <div class="flex flex-wrap justify-between items-center gap-4">
                    ...
                    <div>
                        @if($order->status == 'pending')
                            <span class="bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-sm">Ожидает обработки</span>
                        @elseif($order->status == 'processing')
                            <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm">Обрабатывается</span>
